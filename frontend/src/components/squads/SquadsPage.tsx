            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-800/50 p-4 rounded-lg text-center">
                  <p className="text-2xl font-bold text-white">{squad.totalTournaments}</p>
                  <p className="text-sm text-gray-400">Tournaments</p>
                </div>
                <div className="bg-gray-800/50 p-4 rounded-lg text-center">
                  <p className="text-2xl font-bold text-green-400">{squad.wins}</p>
                  ...
                  {squad.members.map((member: any, index: number) => (
                    <div key={index} className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-white font-semibold">{member.wins} wins</p>
                        <p className="text-sm text-gray-400">{member.kills} kills</p>
                      </div>
                    </div>
                  ))}
                </div>
