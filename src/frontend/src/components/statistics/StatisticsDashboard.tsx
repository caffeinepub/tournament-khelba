...
import { TrendingUp, Trophy, Target, Zap, DollarSign, Gamepad2, Info } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="bg-gradient-to-br from-orange-500/20 to-orange-500/10 border-orange-500/30">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-3xl font-black text-white">{stats.averageKills}</p>
        ...
        <Card className="bg-gradient-to-br from-yellow-500/20 to-yellow-500/10 border-yellow-500/30">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-3xl font-black text-white">৳{stats.totalEarnings}</p>
        ...
        <Card className="bg-gradient-to-br from-pink-500/20 to-pink-500/10 border-pink-500/30">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-3xl font-black text-white">{stats.favoriteMode}</p>
            <p className="text-sm text-gray-400">Fav Mode</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="bg-gray-900/80 border-2 border-cyan-500/30">
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={stats.winRateTrend}>
        ...
        <Card className="bg-gray-900/80 border-2 border-cyan-500/30">
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={stats.killsPerTournament}>
                <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
